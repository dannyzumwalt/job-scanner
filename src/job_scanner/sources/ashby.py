...
def parse_ashby_job(source: SourceConfig, posting: dict) -> NormalizedJob:
    ...
    description = strip_html_tags(posting.get("descriptionHtml") or posting.get("description") or "")
    ...
    apply_url = posting.get("jobUrl") or posting.get("applicationUrl")
    requisition_id = str(posting.get("id") or posting.get("jobId") or "") or None
    ...
    return NormalizedJob(
        ...
        source_job_id=str(requisition_id or ""),
        ...
        compensation_confidence=0.5 if salary_min or salary_max else 0.15,
